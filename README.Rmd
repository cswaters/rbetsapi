...
rbetsapi is an R package to interact with the [BetsAPI](https://betsapi.com/) sports data and odds API.
...
This package requires a BetsAPI API key. You can set it as an environment variable:
...
rbetsapi offers a clean, consistent interface to the BetsAPI with functions for:
